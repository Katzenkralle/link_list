...
import {
  interactivElementChangeHandler, monitorKeyPress, monitorKeyRelease, handleInsertion,
  selectName, deleteListButton, selectTag, selectColor, exitEditorButton, hamburgerIcon, changeViewMode,
} from './ListEditorHelper';
...
function ListEditor(props) {
  ...
  useEffect(() => {
    ...
    const exitOnHashChange = () => {
      if (window.location.hash.replace("#", "") != listId) {
        exitEditor();
      }
    }
    // Key handler
